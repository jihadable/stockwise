...
export default function ProductDetail(props: any): ReactElement {
    ...
    return (
        <div className="product-detail">
            <div className="back" onClick={() => {setShowProductDetail(false)}}>
                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-arrow-left" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
